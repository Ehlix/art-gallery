          ...
          <nav className="container fixed top-0 z-40 flex w-full select-none items-center justify-between gap-7 no-wrap text-t-main bg-t-main-2 h-[60px] md:h-[45px]">
            ...
            "
                ...
                <div className="absolute top-full -mt-2 hidden flex-col group-hover:flex">
                  <div className="p-3 px-5 gap-3 flex-col flex bg-t-main-3 mt-4 rounded-md hover:*:text-t-hover-1">
              ...
              {/*search bar*/}
              <div className="relative flex shrink grow items-center rounded-full group h-[35px] bg-grad-1">
