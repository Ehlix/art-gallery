  ...
  return (
    <div className="flex flex-col gap-[10px]">
          ...
          return (
            <label
              ...
              <input
                ...
                className="cursor-pointer appearance-none p-0 group group-aria-disabled:bg-t-error h-[15px] w-[15px] border-t-main border-[1.7px] rounded-[3px] checked:bg-t-hover-2 checked:border-none disabled:border-t-main/20 disabled:cursor-auto"
                type="checkbox"
                id={v}
                value={v}
                tabIndex={-1000}
      ...
      <div className="flex flex-wrap items-center gap-[5px]">
        ...
        <input
          className="z-20 flex w-full appearance-none items-center justify-center leading-none outline-none border-t-main border-[2px] mb-[-7px] bg-t-main-2 shadow-t-main h-[35px] rounded-t-[3px] px-[10px] text-[15px] text-t-hover-1 placeholder:text-t-main/40 focus:border-t-main"
          type="text"
        ...
        <div
          ...
          <div className="h-[100%] min-w-[200px]">
            <h3 className="flex items-center pl-[25px] mb-[2%] bg-t-main/20 h-[7%]">
                  ...
                  <div
                    ...
                    {subjectStatus
                      ...
                      <button
                        ...
                        <span className="text-t-hover-2 pb-[2px]">
                          <MdAdd/>
                        </span>
                        <span className="md:hidden">
                          Add
